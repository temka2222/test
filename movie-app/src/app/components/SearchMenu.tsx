...
export const SearchMovies = ({
  ...
  return (
    <div
      className={`flex flex-col absolute w-1/3 aspect-[1/1.2] gap-2 bg-white border-solid border-black border top-[80%] left-[30%] z-[500] dark:bg-black dark:text-white`}
    >
      {!loading &&
